...
<head>
    ...
    <body class="container">
        ...
        <h1 class="text-center mt-16 text-3xl">Add a book</h1>

        <form class="text-center mt-32" onsubmit="handleAdd();return false;">

            <div class="flex justify-center">
                <div class="form-group">
                    <label class="text-left w-full" for="title">Author</label>
                    <input type="text" class="form-control w-72" id="title" placeholder="Enter author">
                </div>
            </div>
        ...
        <script async defer src="https://cdn.jsdelivr.net/npm/axios@0.21.0/dist/axios.min.js"></script>
